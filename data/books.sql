...
INSERT INTO books
    (title, authors, isbn, image_url, description, bookshelf)
VALUES
    (
        'Reinforced Concrete Structures',
        'Omar Chaallal',
        'what ever',
        'http://books.google.com/books/content?id=qdsufl6tSV8C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
